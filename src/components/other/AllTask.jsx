...
const AllTask = () => {
  ...
  return (
    ...
    <div id="tasklist" className='bg-[#1c1c1c] p-5 mt-5 rounded-xl h-1/2'>
        ...
        {userData.map(function(elem,idx){
            return <div key={idx} className='border-2 border-red-400 mb-2 py-2 px-4 flex justify-between rounded'>
            <h2 className='text-lg font-medium w-1/5'>{elem.name}</h2>
            <h3 className='text-lg font-medium w-1/5 text-blue-400'>{elem.taskCounts.newTasks}</h3>
